...
//
// PRODUCTION_REPOS is the protected set: repos that stay human-merge regardless
// of test state, because their blast radius is too large to auto-merge into. A
// repo joins this set the day it starts serving live revenue or public traffic.
// EDIT THIS LIST to name your own protected repos. The names below are neutral
// examples, not a live system. This is blast-radius, not distrust.
export const PRODUCTION_REPOS = [
  "billing-service",
  "payments-api",
  "checkout-web",
  "user-directory",
...
export function mergeVerdict(lane, checks) {
  const reasons = [];
  ...
  if (PRODUCTION_REPOS.includes(lane.repo))
